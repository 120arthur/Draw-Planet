...
public class Seguimento_Perna : MonoBehaviour, IPointerDownHandler, IPointerUpHandler
{
    [SerializeField]
    ...
    [SerializeField]
    private Material MaterialDosJoelhos;
    ...
    public void OnPointerDown(PointerEventData eventData)
    {
        ...
        LRDesenhoDaPerna.startWidth = 0.2f;

        LRDesenhoDaPerna.material = MaterialDosJoelhos;
    }
